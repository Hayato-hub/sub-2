...
<html>
    <head>
        ...
        <link href="{{ secure_asset('css/uraLive.css') }}" rel="stylesheet">
    ...
    <body>
        ...
        <div class="big-body">
            <div class="body-top">
                ...
                <a href="https://preaf.jp/pa.do?s=v04031&o=46959&guid=ON" target="_blank" class="btn-square-shadow"><i class="fab fa-apple"></i>【公式】AppStoreはコチラ <i class="fas fa-external-link-alt"></i></a>
